...
"")
        ...
        self.min10_2 = QtWidgets.QProgressBar(self.Central)
        self.min10_2.setGeometry(QtCore.QRect(32, 498, 106, 43))
        self.min10_2.setStyleSheet("QProgressBar{\n"
...
"border-radius:21px;\n"
"}")
        self.min10_2.setProperty("value", 0)
        self.min10_2.setObjectName("min10_2")
        bm = QBitmap(self.min10_2.size())
        bm.fill(Qt.color0)
        p = QPainter(bm)
        ...
        p.end()
        self.min10_2.setMask(bm)
        self.min50_2 = QtWidgets.QProgressBar(self.Central)
        self.min50_2.setGeometry(QtCore.QRect(143, 498, 530, 43))
        self.min50_2.setStyleSheet("QProgressBar{\n"
"background-color:rgba(45,45,45,0.5);\n"
"border-radius:21px;\n"
"text-align:center;\n"
"color:white;\n"
...
"border-radius:21px;\n"
"}")
        self.min50_2.setProperty("value", 5)
        self.min50_2.setObjectName("min50_2")
        bm = QBitmap(self.min50_2.size())
        bm.fill(Qt.color0)
        p = QPainter(bm)
        p.setRenderHint(QPainter.HighQualityAntialiasing)
        p.setPen(Qt.color1)
